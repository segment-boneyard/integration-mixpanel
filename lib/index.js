...
function formatProperties(track, settings){
  ...
  // Doing this here because object.del will strip special chars including $ signs and thus will overwrite the following extend operation
  var referrer = track.referrer();
